...
const Menu = () => {
  ...
  return (
    <div className="min-h-screen via-blue-600 to-indigo-700 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <div className="text-center mb-8">
          <User className="w-16 h-16 mx-auto text-purple-600 mb-3" />
          <h2 className="text-3xl font-bold text-gray-800">Welcome, {playerName}!</h2>
        </div>
